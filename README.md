...
2.Changing Data Types: Corrected and standardized data types, such as dates, numerical fields, and categorical fields, to ensure the data could be analyzed correctly.
3.PivotTables: Used PivotTables to summarize and explore patient information, including patient counts, departments, outcomes, payment status, diagnoses, and other key metrics.
4.Data Validation and Consistency Checks: Reviewed the dataset for inconsistent or unsuitable values before using it for dashboard development.
...
<img width="1223" height="714" alt="hospital executive screenshot" src="https://github.com/user-attachments/assets/ba777abb-7bc1-4a77-b996-0501fb07386e" />
...
General Medicine recorded the highest patient volume, with 168 patients, followed by Cardiology with 140 patients.
General Medicine also generated the highest departmental revenue.
...
Hypertension was the most frequently recorded diagnosis, followed by pneumonia.
Other common diagnoses included malaria, asthma, and diabetes-related conditions.

### Operational Insights
The analysis identified patient waiting time and unpaid or pending payments as areas requiring management attention.
Monthly admission fluctuations may also have implications for staffing, bed capacity, and resource planning.
